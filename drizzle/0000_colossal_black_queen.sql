...
CREATE TABLE `logged_food` (
	`id` integer PRIMARY KEY NOT NULL,
	`logged_name` text NOT NULL,
	`logged_protein` real NOT NULL,
	`logged_carbs` real NOT NULL,
	`logged_fat` real NOT NULL,
	`logged_serving_size_value` real NOT NULL,
	`logged_serving_size_unit` text NOT NULL,
